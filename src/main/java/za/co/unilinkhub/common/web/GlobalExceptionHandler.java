...
/**
 * Translates domain/application exceptions into a consistent JSON error shape
 * so every controller in every module can just throw and not worry about status codes.
 */
